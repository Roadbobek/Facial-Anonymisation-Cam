...
while True:
    ...
    if more_than_one_face: # Used to use face_encodings
        ...
        for (top, right, bottom, left) in face_locations:
            ...
            if black_box and not image_overlay:
    ...
    if fps_counter:
        ...
        cv2.putText(frame, f"FPS: {fps:.2f}", (fps_horz_pos, fps_vert_pos), cv2.FONT_HERSHEY_DUPLEX, 1.0, (33, 33, 33), 2)
    ...
    cv2.putText(frame, title_text, (title_horz_pos, title_vert_pos), cv2.FONT_HERSHEY_DUPLEX, 2.0, (33, 33, 33), 4)
